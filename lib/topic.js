...
exports.create = function(request, response) {
    db.query('SELECT * FROM topic', function(error, topics) {
        ...
        db.query('SELECT * FROM author', function(error2, authors) {
            ...
            var html = Template.html(title, listText,``,
                `
        ...
        db.query('SELECT * FROM topic WHERE id=?',[id],function(error2, topic) {
            db.query('SELECT * FROM author', function(error3, authors) {
                ...
                var html = Template.html(title, listText, `
                    ...
                    <input type="hidden" name="id" value="${sanitizeHTML(id)}">
...
exports.update_process = function(request, response) {
    ...
    request.on('end', function() {
        ...
        db.query(dbquery, [newTitle, description, author_id, id], function(error, result) {
            if(error) throw error;
